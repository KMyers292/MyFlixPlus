...
import { sortList, fetchTrendingMedia, checkForNewEpisodes, checkForNewEpisodesWatchList } from '../context/directory/DirectoryActions';
...
const DirectorySearchResults = () => {
    ...
    useEffect(() => {
        const getData = async () => {
            ...
            await checkForNewEpisodesWatchList();
